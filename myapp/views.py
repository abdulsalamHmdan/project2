...
def home(request):
    my_list = [
        ...
        },
        {
            "type": "t1",
            "id": "HighChol",
            "title": "تعاني من ارتفاع بالكلسترول",
            "icon": "",
        },
        {
            "type": "t1",
            "id": "CholCheck",
            "title": "عملت فحص كلتسرول بالخمس سنين الماضية",
            "icon": "",
        },
        {"type": "t1", "id": "Smoker", "title": "مدخن", "icon": ""},
        {
            "type": "t1",
            "id": "HeartDiseaseorAttack",
            "title": "لديك امراض قلب",
            "icon": "",
        },
        {"type": "t1", "id": "Fruits", "title": "تتناول الفواكه يوميا", "icon": ""},
        {
            "type": "t1",
            "id": "PhysActivity",
        ...
        },
        {
            "type": "t1",
            "id": "Veggies",
            "title": "تتناول الخضار مرة واحدة باليوم على الأقل",
            "icon": "",
        },
        {"type": "t1", "id": "DiffWalk", "title": "تواجه مشاكل في المشي", "icon": ""},
        {"type": "t1", "id": "Stroke", "title": "سبق وتعرضت لجلطة", "icon": ""},
        {"type": "t1", "id": "HighBP", "title": "لديك ارتفاع في ضغط الدم", "icon": ""},
        {
            "type": "t2",
            "id": "PhysHlth",
            "title": "كم مرة تعرضت لاصابة في جسمك خلال الثلاثين يوم الماضية",
            "placeholder": "1..",
            "max": 30,
            "min": 0,
        },
        ...
        },
        {
            "type": "t3",
            "id": "GenHlth",
            "title": "قيم صحتك العامة من ١ الى خمسة (١ ممتازة جداً ٥ سيئة جداً)",
            "list": [
                {"value": 1, "title": "1"},
                {"value": 2, "title": "2"},
                {"value": 3, "title": "3"},
